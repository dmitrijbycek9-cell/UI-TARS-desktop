...
export const t = {
  ...
  recipes: {
    ...
    seedBadge: 'Kochbuch',
    all: 'Alle',
    search: 'Rezept suchen …',
    watchVideo: 'Koch-Video ansehen',
    videoUrl: 'Link zum Koch-Video',
    photo: 'Foto',
  ...
  fitness2: {
    exercises: 'Übungen (Yoga & Pilates)',
    start: 'Übung starten',
    done: 'Fertig – als Training speichern',
    duration: 'Dauer',
    pause: 'Pause',
    resume: 'Weiter',
    finishEarly: 'Beenden',
    saved: 'Übung als Training gespeichert.',
  },
  fitness: {
    title: 'Fitness',
    steps: 'Schritte',
